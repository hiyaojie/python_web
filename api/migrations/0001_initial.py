# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2018-06-19 15:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('女', '女'), ('男', '男')], max_length=10, null=True, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income', models.IntegerField(verbose_name='营业额')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_num', models.CharField(max_length=100, unique=True, verbose_name='订单号')),
                ('order_date', models.DateField(blank=True, null=True, verbose_name='订单日期')),
                ('sales', models.CharField(blank=True, max_length=150, null=True, verbose_name='销售员')),
                ('customer', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户名')),
                ('customer_source', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户来源')),
                ('useage', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户用途')),
                ('useage_detail', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户用途细分')),
                ('place', models.CharField(blank=True, max_length=100, null=True, verbose_name='使用场所')),
                ...
                ('sale_source', models.CharField(blank=True, max_length=100, null=True, verbose_name='销售渠道')),
                ('wangwang', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户旺旺号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_num', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Order', to_field='order_num')),
            ],
            options={
                'verbose_name_plural': '订单物品明细',
                'verbose_name': '订单物品明细',
            },
        ),
        migrations.CreateModel(
