# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-06-27 09:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('series_num', models.CharField(blank=True, max_length=100, null=True, verbose_name='产品序列号')),
                ...
                ('sale_source', models.CharField(max_length=100, null=True, verbose_name='销售渠道')),
                ('wangwang', models.CharField(blank=True, max_length=100, null=True, verbose_name='客户旺旺号')),
                ('price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='应收总价')),
                ('reciever', models.CharField(max_length=100, null=True, verbose_name='收件人')),
                ('phone', models.CharField(max_length=100, null=True, verbose_name='收件人联系方式')),
                ('address', models.TextField(null=True, verbose_name='收件地址')),
                ('remark', models.CharField(blank=True, max_length=255, null=True, verbose_name='订单备注')),
            ],
            options={
